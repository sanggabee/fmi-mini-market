...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'delivery_prize',array('size'=>20,'maxlength'=>10)); ?>
		<?php echo $form->error($model,'delivery_prize'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'sell_prize'); ?>
		<?php echo $form->textField($model,'sell_prize',array('size'=>20,'maxlength'=>10)); ?>
		<?php echo $form->error($model,'sell_prize'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'current_quantity'); ?>
		<?php echo $form->textField($model,'current_quantity',array('size'=>20,'maxlength'=>10)); ?>
		<?php echo $form->error($model,'current_quantity'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'minimum_quantity'); ?>
		<?php echo $form->textField($model,'minimum_quantity',array('size'=>20,'maxlength'=>10)); ?>
